    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doctors.update", [$doctor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $doctor->designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specilities') ? 'is-invalid' : '' }}" type="text" name="specilities" id="specilities" value="{{ old('specilities', $doctor->specilities) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $doctor->department) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="text" name="nid" id="nid" value="{{ old('nid', $doctor->nid) }}">
                @if($errors->has('nid'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Doctor::GENDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', $doctor->gender) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $doctor->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{!! old('address', $doctor->address) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('special_achievement') ? 'is-invalid' : '' }}" name="special_achievement" id="special_achievement">{!! old('special_achievement', $doctor->special_achievement) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('history') ? 'is-invalid' : '' }}" name="history" id="history">{!! old('history', $doctor->history) !!}</textarea>
