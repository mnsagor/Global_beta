                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.doctors.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('specilities') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="specilities" id="specilities" value="{{ old('specilities', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('special_achievement') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="special_achievement" id="special_achievement">{!! old('special_achievement') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('history') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="history" id="history">{!! old('history') !!}</textarea>
