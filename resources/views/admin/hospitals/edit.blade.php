                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hospitals.update", [$hospital->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $hospital->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                ...
                                @foreach(App\Hospital::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $hospital->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="address" id="address">{!! old('address', $hospital->address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('manager_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', $hospital->manager_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('manager_phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_phone_number" id="manager_phone_number" value="{{ old('manager_phone_number', $hospital->manager_phone_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('techonologist_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="techonologist_name" id="techonologist_name" value="{{ old('techonologist_name', $hospital->techonologist_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('technologist_phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="technologist_phone_number" id="technologist_phone_number" value="{{ old('technologist_phone_number', $hospital->technologist_phone_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('receptionist_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receptionist_name" id="receptionist_name" value="{{ old('receptionist_name', $hospital->receptionist_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('receptionist_phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receptionist_phone_number" id="receptionist_phone_number" value="{{ old('receptionist_phone_number', $hospital->receptionist_phone_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('route_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="route_title" id="route_title" value="{{ old('route_title', $hospital->route_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('route_ae_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="route_ae_title" id="route_ae_title" value="{{ old('route_ae_title', $hospital->route_ae_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('route_host_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="route_host_name" id="route_host_name" value="{{ old('route_host_name', $hospital->route_host_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('route_port') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="route_port" id="route_port" value="{{ old('route_port', $hospital->route_port) }}">
                        ...
                        <div class="form-group {{ $errors->has('pacs_destinaiton_ae_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pacs_destinaiton_ae_title" id="pacs_destinaiton_ae_title" value="{{ old('pacs_destinaiton_ae_title', $hospital->pacs_destinaiton_ae_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('pacs_ae_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pacs_ae_title" id="pacs_ae_title" value="{{ old('pacs_ae_title', $hospital->pacs_ae_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('pacs_host_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pacs_host_name" id="pacs_host_name" value="{{ old('pacs_host_name', $hospital->pacs_host_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('pacs_port') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pacs_port" id="pacs_port" value="{{ old('pacs_port', $hospital->pacs_port) }}">
