    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hospitals.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hospital_code') ? 'is-invalid' : '' }}" type="text" name="hospital_code" id="hospital_code" value="{{ old('hospital_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manager_name') ? 'is-invalid' : '' }}" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manager_phone_number') ? 'is-invalid' : '' }}" type="text" name="manager_phone_number" id="manager_phone_number" value="{{ old('manager_phone_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('techonologist_name') ? 'is-invalid' : '' }}" type="text" name="techonologist_name" id="techonologist_name" value="{{ old('techonologist_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('technologist_phone_number') ? 'is-invalid' : '' }}" type="text" name="technologist_phone_number" id="technologist_phone_number" value="{{ old('technologist_phone_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receptionist_name') ? 'is-invalid' : '' }}" type="text" name="receptionist_name" id="receptionist_name" value="{{ old('receptionist_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receptionist_phone_number') ? 'is-invalid' : '' }}" type="text" name="receptionist_phone_number" id="receptionist_phone_number" value="{{ old('receptionist_phone_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('route_title') ? 'is-invalid' : '' }}" type="text" name="route_title" id="route_title" value="{{ old('route_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('route_ae_title') ? 'is-invalid' : '' }}" type="text" name="route_ae_title" id="route_ae_title" value="{{ old('route_ae_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('route_host_name') ? 'is-invalid' : '' }}" type="text" name="route_host_name" id="route_host_name" value="{{ old('route_host_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('route_port') ? 'is-invalid' : '' }}" type="text" name="route_port" id="route_port" value="{{ old('route_port', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pacs_destinaiton_ae_title') ? 'is-invalid' : '' }}" type="text" name="pacs_destinaiton_ae_title" id="pacs_destinaiton_ae_title" value="{{ old('pacs_destinaiton_ae_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pacs_ae_title') ? 'is-invalid' : '' }}" type="text" name="pacs_ae_title" id="pacs_ae_title" value="{{ old('pacs_ae_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pacs_host_name') ? 'is-invalid' : '' }}" type="text" name="pacs_host_name" id="pacs_host_name" value="{{ old('pacs_host_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pacs_port') ? 'is-invalid' : '' }}" type="text" name="pacs_port" id="pacs_port" value="{{ old('pacs_port', '') }}">
