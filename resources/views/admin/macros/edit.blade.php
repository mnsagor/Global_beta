                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.macros.update", [$macro->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $macro->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('details') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="details" id="details">{!! old('details', $macro->details) !!}</textarea>
