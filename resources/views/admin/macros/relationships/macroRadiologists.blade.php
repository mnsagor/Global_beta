    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-macroRadiologists">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  $('.datatable-macroRadiologists:not(.ajaxTable)').DataTable({ buttons: dtButtons })
