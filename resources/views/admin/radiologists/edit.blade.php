                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.radiologists.update", [$radiologist->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $radiologist->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                ...
                                @foreach(App\Radiologist::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $radiologist->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="address" id="address">{!! old('address', $radiologist->address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="designation" id="designation" value="{{ old('designation', $radiologist->designation) }}">
