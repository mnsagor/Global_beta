            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.radiologists.store") }}" enctype="multipart/form-data">
                        ...
                        <input id="roles" name="roles[]" type="hidden" value="3">
...
{{--                            <select class="form-control" name="approved" id="approved" required>--}}
...
{{--                                    <option value="{{ $key }}" {{ old('approved', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
{{--                            @if($errors->has('approved'))--}}
{{--                                <span class="help-block" role="alert">{{ $errors->first('approved') }}</span>--}}
...
{{--                            </div>--}}
{{--                            <select class="form-control select2" name="roles[]" id="roles" type="hidden" required>--}}
