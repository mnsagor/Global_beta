            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Radiologist">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  $('.datatable-Radiologist:not(.ajaxTable)').DataTable({ buttons: dtButtons })
