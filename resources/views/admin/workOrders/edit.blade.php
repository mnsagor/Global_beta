    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.work-orders.update", [$workOrder->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registration_number') ? 'is-invalid' : '' }}" type="text" name="registration_number" id="registration_number" value="{{ old('registration_number', $workOrder->registration_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data') ? 'is-invalid' : '' }}" type="text" name="data" id="data" value="{{ old('data', $workOrder->data) }}" required>
                @if($errors->has('data'))
