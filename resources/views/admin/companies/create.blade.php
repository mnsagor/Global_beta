    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web_address') ? 'is-invalid' : '' }}" type="text" name="web_address" id="web_address" value="{{ old('web_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fb_address') ? 'is-invalid' : '' }}" type="text" name="fb_address" id="fb_address" value="{{ old('fb_address', '') }}">
