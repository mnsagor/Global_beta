            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-modalityWorkOrders">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  $('.datatable-modalityWorkOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
