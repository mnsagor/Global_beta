    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dof') ? 'is-invalid' : '' }}" type="text" name="dof" id="dof" value="{{ old('dof') }}">
                @if($errors->has('dof'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('clinical_history') ? 'is-invalid' : '' }}" name="clinical_history" id="clinical_history">{!! old('clinical_history') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('surgical_history') ? 'is-invalid' : '' }}" name="surgical_history" id="surgical_history">{!! old('surgical_history') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lab_results') ? 'is-invalid' : '' }}" type="text" name="lab_results" id="lab_results" value="{{ old('lab_results', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('deo_comments') ? 'is-invalid' : '' }}" name="deo_comments" id="deo_comments">{!! old('deo_comments') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('clinical_diagnosis') ? 'is-invalid' : '' }}" name="clinical_diagnosis" id="clinical_diagnosis">{!! old('clinical_diagnosis') !!}</textarea>
