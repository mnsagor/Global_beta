                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('dof') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="dof" id="dof" value="{{ old('dof') }}">
                            @if($errors->has('dof'))
                        ...
                        <div class="form-group {{ $errors->has('clinical_history') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="clinical_history" id="clinical_history">{!! old('clinical_history') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('surgical_history') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="surgical_history" id="surgical_history">{!! old('surgical_history') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('lab_results') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="lab_results" id="lab_results" value="{{ old('lab_results', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('deo_comments') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="deo_comments" id="deo_comments">{!! old('deo_comments') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('clinical_diagnosis') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="clinical_diagnosis" id="clinical_diagnosis">{!! old('clinical_diagnosis') !!}</textarea>
